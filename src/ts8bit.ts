...
export type Rsh<
  T extends [Bit, Bit, Bit, Bit, Bit, Bit, Bit, Bit],
  I extends Index
> = I extends 0
  ? T
...
export type Lte<
  A extends [Bit, Bit, Bit, Bit, Bit, Bit, Bit, Bit],
  B extends [Bit, Bit, Bit, Bit, Bit, Bit, Bit, Bit]
> = [Eq<A, B>, Lt<A, B>] extends [true, false]
  ? true
...
export type Gte<
  A extends [Bit, Bit, Bit, Bit, Bit, Bit, Bit, Bit],
  B extends [Bit, Bit, Bit, Bit, Bit, Bit, Bit, Bit]
> = [Eq<A, B>, Gt<A, B>] extends [true, false]
  ? true
...
export type Byte<T extends number> = T extends 0
  ? [0, 0, 0, 0, 0, 0, 0, 0]
  : T extends 1
  ? [1, 0, 0, 0, 0, 0, 0, 0]
  : T extends 2
